<head>
    ...
    <title></title>
<link rel="stylesheet" href="animate/css/normalize.css">

<!--必要样式-->
<link rel="stylesheet" href="animate/css/style.css" media="screen" type="text/css" />
...
<script type="text/javascript" src='animate/js/jquery.js'></script>
<script type="text/javascript" src='animate/js/tween.min_1.js'></script>
<script type=
        "text/javascript" src="animate/js/script.js"></script>
</body>